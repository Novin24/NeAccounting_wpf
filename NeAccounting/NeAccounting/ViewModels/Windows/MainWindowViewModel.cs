    ...
    public partial class MainWindowViewModel : ObservableObject
    {
        ...
        private ObservableCollection<object> _footerMenuItems = new()
        {
            new NavigationViewItem()
            {
                ...
                {
					#region systemUser
					new NavigationViewItem {Content = "کاربران سیستم",TargetPageType = typeof(UserListPage) , Icon = new SymbolIcon{ Symbol = SymbolRegular.PersonSettings20,Filled = true} },
					#endregion
                    #region ChangePassword
                    new NavigationViewItem {Content = "تغییر رمز عبور",TargetPageType = typeof(ChangePassword) , Icon = new SymbolIcon{ Symbol = SymbolRegular.LockMultiple20,Filled = true} },
                #endregion
                    #region Notification
                    new NavigationViewItem {Content = "یادآورها",TargetPageType = typeof(NotificationListPage) , Icon = new SymbolIcon{ Symbol = SymbolRegular.CalendarCheckmark20 , Filled = true} },
