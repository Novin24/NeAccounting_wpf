...
{
    /// <summary>
    /// Interaction logic for FromTheBuyPage.xaml
    /// </summary>
    public partial class FromTheBuyPage : INavigableView<FromTheBuyViewModel>
    {
        private readonly ISnackbarService _snackbarService;
        public FromTheBuyViewModel ViewModel { get; }
        private long _price;

        public FromTheBuyPage(ISnackbarService snackbarService, FromTheBuyViewModel viewModel)
        {
            ViewModel = viewModel;
            DataContext = this;
        ...
        {
            if (DataContext is not FromTheBuyPage fts)
            {
                return;
            }
