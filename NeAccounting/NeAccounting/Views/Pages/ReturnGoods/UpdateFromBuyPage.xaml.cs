...
{
    /// <summary>
    /// Interaction logic for UpdateFromBuyPage.xaml
    /// </summary>
    public partial class UpdateFromBuyPage : INavigableView<UpdateFromTheBuyViewModel>
    {
        private readonly ISnackbarService _snackbarService;
        public UpdateFromTheBuyViewModel ViewModel { get; }
        //private double _totalEntity;
        private long _price;
        public UpdateFromBuyPage(ISnackbarService snackbarService, UpdateFromTheBuyViewModel viewModel)
        {
            DataContext = this;
            ViewModel = viewModel;
            InitializeComponent();
        ...
        {
            if (DataContext is not UpdateFromBuyPage fts)
            {
                return;
            }
