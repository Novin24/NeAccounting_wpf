...
namespace Infrastructure.Migrations.NovinDb
{
    ...
    [Migration("20240529131030_editPunProductRatio")]
    partial class editPunProductRatio
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.NovinEntity.Materials.PunProduct", b =>
                {
                    ...
                    b.Property<byte>("WastePercentage")
                        .HasColumnType("tinyint");

                    b.HasKey("ProductionId", "RawMaterialId");

                    b.HasIndex("RawMaterialId");

                    b.ToTable("PunProduct");
                });
